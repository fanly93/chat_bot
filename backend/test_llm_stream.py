...
ZHIPU_API_KEY = "a343517f614d492c976f228f280a5e53.anNaP0spr6IQUAoE"
...
def test_glm4_stream_no_thinking():
    """测试 DeepSeek deepseek-chat 模型不开启思考模式的流式输出"""
    print(SEPARATOR)
    print("TEST 2: DeepSeek deepseek-chat 普通模式 (流式, 无思考)")
    print(SEPARATOR)
...
if __name__ == "__main__":
    ...
    test_glm4_stream_thinking()
    test_glm4_stream_no_thinking()
    print(SEPARATOR)
    print("全部测试完成")
